...
从 [v0.1.0-beta1 Release](https://github.com/caeser2/unraid-usb-guardian/releases/tag/v0.1.0-beta1) 下载 PLG 和 TXZ，然后把 TXZ 放进插件私有目录，把 PLG 放到 `/boot/config/plugins` 根目录：
...
Download the PLG and TXZ from the [v0.1.0-beta1 release](https://github.com/caeser2/unraid-usb-guardian/releases/tag/v0.1.0-beta1). Place the TXZ in the plugin's private directory and the PLG in the root `/boot/config/plugins` directory:
